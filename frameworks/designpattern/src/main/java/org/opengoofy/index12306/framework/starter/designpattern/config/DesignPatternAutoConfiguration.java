 ...
 *
 */
@ImportAutoConfiguration(ApplicationBaseAutoConfiguration.class)//这个注解将另一个自动配置类 ApplicationBaseAutoConfiguration 导入到当前的自动配置类中。这意味着 ApplicationBaseAutoConfiguration 中定义的配置将在这个自动配置类中生效。
